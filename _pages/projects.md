...
Xiang et al. (2025). Toward task mapping of primate prefrontal cortex. $\textit{Neuropsychologia.}$ [paper](https://doi.org/10.1016/j.neuropsychologia.2025.109234)
Xiang et al. (2025). Task-specific topographic maps of neural activity in the primate lateral prefrontal cortex. $\textit{Nature Communications.}$ (under review) [paper](https://www.biorxiv.org/content/10.1101/2024.05.10.591729v2)
